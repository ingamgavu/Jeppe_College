...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
         <link rel="shortcut icon" href="public/img/jlogo.jpg">
        <title>JeppeCollege</title>
...
<link rel="stylesheet" type="text/css" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <!-- Styles -->
    ...
    <body class="antialiased bg-gray-200">
       ...
       <div class="px-4">
       <div class="max-w-5xl bg-white rounded-lg mx-auto my-16 p-16 ">   
        <h1 class="text-2xl font-medium mb-2">
            <img src="public/img/jlogo.jpg" width="200" height="60">Welcome the Jeppe College Student portal!</h1>   
        <h2 class="font-meduim text-sm text-indigo-400 mb-4 uppercase tracking-wide">To register you first have to register account</h2>
        <img src="public/img/welcome.jpg" width="700" height="10">
    </div>
    </div>
